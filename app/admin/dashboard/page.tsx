...
import { Users, BookOpen, Bell, AlertTriangle, BookOpenCheck, Menu, X, CreditCard, RefreshCw } from "lucide-react"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">
                      {loading ? "..." : stats.videoStats.totalViews.toLocaleString()}
                    </p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">
                      ₹{loading ? "..." : stats.revenueStats.monthly.toLocaleString()}
                    </p>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">
                      ₹{loading ? "..." : stats.revenueStats.annual.toLocaleString()}
                    </p>
