...
export default function PlansPage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 py-20">
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
      ...
      <div className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 mb-8 leading-tight">
              ...
              <span className="relative">
                Wellness Path
                <div className="absolute -bottom-2 left-0 right-0 h-3 bg-gradient-to-r from-emerald-400/30 to-teal-400/30 rounded-full"></div>
              </span>
            </h1>
          ...
          {/* Call to Action */}
          <div className="mt-24">
            <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 rounded-3xl p-12 text-white relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 text-center">
                <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 text-sm font-semibold mb-6">
                ...
                <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto font-light">
                  ...
                  <span className="font-bold"> Your wellness journey starts here!</span>
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Link href="/user/register">
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-2 border-white text-white hover:bg-white hover:text-emerald-600 text-lg font-bold px-8 py-4 h-auto"
                    >
