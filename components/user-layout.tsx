...
import { LayoutDashboard, PlayCircle, Clock, Bell, LogOut, Menu, X, CreditCard, User } from "lucide-react"
...
export function UserLayout({ children }: UserLayoutProps) {
  ...
  useEffect(() => {
    ...
    console.log("User auth check:", { userId, userAuthenticated })

    if (userId && userAuthenticated === "true") {
  ...
  const navigation = [
    ...
    { name: "Access Course", href: "/user/access-course", icon: PlayCircle },
    { name: "Previous Sessions", href: "/user/previous-sessions", icon: Clock },
    { name: "Subscriptions", href: "/user/subscriptions", icon: CreditCard },
