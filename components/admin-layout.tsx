...
import { Menu, LogOut, PiIcon as ApiIcon, Star } from "lucide-react"
                        ...
                        >
                          ...
                          {item.icon === "gift" && (
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M21 11.5V14a6 6 0 01-6 6H9a6 6 0 01-6-6V11.5a6 6 0 016-6H15a6 6 0 016 6z"
                            />
                          )}
                          {item.icon === "link" && (
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 0 001.242 7.244"
                            />
                          )}
                        </svg>
                      </span>
